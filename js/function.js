(function ($) {
	...
	/* Brand Item Slider JS */
	if ($('.brand-item-slider').length) {
		const new_arrival_slider = new Swiper('.brand-item-slider .swiper', {
			slidesPerView : 1,
			speed: 2500,
			spaceBetween: 10,
			loop: true,
	...
	if ($('.new-arrival-slider').length) {
		const new_arrival_slider = new Swiper('.new-arrival-slider .swiper', {
			slidesPerView : 1,
			speed: 2500,
			spaceBetween: 10,
			loop: true,
	...
	/* Why Choose Slider Slider JS */
	var swiper = new Swiper(".why-choose-img-item", {
		spaceBetween: 15,
		slidesPerView: 3,
		loop: true,
		breakpoints: {
	...
	var swiper2 = new Swiper(".why-choose-img-slider", {
		spaceBetween: 10,
		effect: 'fade',
		loop: true,
		speed: 1000,
	...
	/* Our History Image Slider */
	if ($('.history-image-slider').length) {
		const our_history_image_slider = new Swiper('.history-image-slider .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	/* Hero Image Slider Gold JS */
	const hero_slider_gold = new Swiper('.hero-slider-gold .swiper', {
		effect: 'fade',
		slidesPerView : 1,
		speed: 1000,
		spaceBetween: 0,
		...
		pagination: {
			el: '.hero-pagination-gold',
			clickable: true,
		},
		navigation: {
			nextEl: '.hero-slider-next-gold',
			prevEl: '.hero-slider-prev-gold',
		},
	});
	...
	/* Collection Item List Demo 3 Start */
	var $collection_item_list_gold = $('.collection-item-list-gold');
	if ($collection_item_list_gold.length) {
		var $collection_item_gold = $collection_item_list_gold.find('.collection-item-gold');

		if ($collection_item_gold.length) {
			$collection_item_gold.on({
				mouseenter: function () {
					if (!$(this).hasClass('active')) {
						$collection_item_gold.removeClass('active'); 
	...
	/* Collection Item List Demo 3 End */
